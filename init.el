...
(custom-set-variables
 ...
 '(package-selected-packages
   '(multi-vterm vterm slime ac-slime lua-mode csv-mode string-inflection sql-indent sqlup-mode sqlformat graphql-mode tide ac-racer auto-complete web-mode yaml-mode elpy racer cargo rust-mode exec-path-from-shell markdown-mode blackboard-theme magit js2-mode))
