...
(custom-set-variables
 ...
 '(package-selected-packages
   '(slime-company company-quickhelp company company-tabnine multi-vterm vterm slime lua-mode csv-mode string-inflection sql-indent sqlup-mode sqlformat graphql-mode tide web-mode yaml-mode elpy racer cargo rust-mode exec-path-from-shell markdown-mode blackboard-theme magit js2-mode))
